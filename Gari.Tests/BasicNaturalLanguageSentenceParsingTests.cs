...
namespace Gari.Tests
{
    ...
    public sealed class BasicNaturalLanguageSentenceParsingTests
    {
        ...
        {
            RussianGariParser.PrebuiltParsers["неверно, что отец Сократа стар"].Match(SolarixParserMemoizer.Parse("неверно, что отец Сократа стар").Single());
        }
        ...
        private static readonly IDictionary<string, string> ParsingSamples =
            new Dictionary<string, string>
            {
              ...
              // (∃ x) x ∈ S ⇒  P(f(x)) 
                ...
                { "существуют кастрюли с кипящим содержимым", "(∃ x) x ∈ set<Кастрюля> & КИПЕТЬ(Содержимое(x))" }, 
              // (∀ x) x ∈ S ⇒  ¬P(x) 
